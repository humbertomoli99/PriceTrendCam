...
namespace PriceTrendCam.UserControls;
...
public sealed partial class EverydayPhrasesUserControl : UserControl
{
    ...
    public EverydayPhrasesUserControlViewModel ViewModel
    {
        get;
    }
    ...
    {
        ViewModel = App.GetService<EverydayPhrasesUserControlViewModel>();
        InitializeComponent();
    ...
    public ICommand CompletePhraseCommand
    {
        get
        {
            return (ICommand)GetValue(CompletePhraseCommandProperty);
        }
        set
        {
            SetValue(CompletePhraseCommandProperty, value);
        }
    }
    ...
    public Dictionary<string, string> PhrasesSource
    {
        get
        {
            return (Dictionary<string, string>)GetValue(PhrasesSourceProperty);
        }
        set
        {
            SetValue(PhrasesSourceProperty, value);
        }
    }
